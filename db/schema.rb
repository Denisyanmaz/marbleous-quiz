...
ActiveRecord::Schema.define(version: 2022_03_27_115919) do
  ...
  create_table "user_choices", force: :cascade do |t|
    ...
    t.index ["user_quiz_id"], name: "index_user_choices_on_user_quiz_id"
  end
  ...
  add_foreign_key "user_choices", "options"
  add_foreign_key "user_choices", "user_quizzes"
